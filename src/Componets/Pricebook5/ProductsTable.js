    ...
    <section>
        ...
        <div style={{ maxHeight: '50em', overflowY: 'auto' }} className='border rounded-lg overflow-hidden'>
            <table>
                <thead>
                    <tr>
                        <th className='font-medium text-left'>Shopee Id</th>
                ...
                {products.length > 0 ? products.map((item, index) => {
                    ...
                    }) : error === null && !isBusy && <tr><td colSpan='11' className='text-center'>No results</td></tr> }
                { error && !isBusy && <tr><td colSpan='11' className='text-center'>An error occurred:(</td></tr> }
                { !isBusy && !hasMore && products.length !== 0 && <tr><td colSpan='11' className='text-center'>That's it.</td></tr> }
                { isBusy && (
